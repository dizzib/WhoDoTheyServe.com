...
MaintBW = require \./maint/bil-edges-when
Prod    = require \./prod
Site    = require \./site
...
const COMMANDS =
  ...
  * cmd:'s.mb ' lev:0 desc:'stage - maint: fix bil-when' fn:MaintBW.staging
...
# * cmd:'p.l  ' lev:1 desc:'prod  - login'               fn:Prod.af.login
  ...
  * cmd:'p.mb ' lev:1 desc:'prod  - maint: fix bil-when' fn:MaintBW.prod
