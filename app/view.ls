...
exports
  ...
  ..evidence-edit       = new V.EditView template:T-EvidenceEdit , el:\.view>.evidence
  ...
  ..evidences-void      = new V.DocuView document:T-EvidencesVoid, el:\.view>.evidences-void
  ...
  ..note-edit           = new V.EditView template:T-NoteEdit     , el:\.view>.note
