...
exports
  ...
  ..edge                = new V.InfoView template:T-Edge         , el:\.view>.edge
  ...
  ..node                = new V.InfoView template:T-Node         , el:\.view>.node
  ...
  ..session             = new V-Session                            el:\.view>.session
  ..user                = new V.InfoView template:T-User         , el:\.view>.user
