...
exports
  ..set-fns = (Model, opts) ->
    Model.crud-fns =
      create : exports.get-invoker Model, exports.create
      read   : exports.get-invoker Model, exports.read
      update : exports.get-invoker Model, exports.update
      delete : exports.get-invoker Model, exports.delete
      list   : exports.get-invoker Model, exports.list
    Model
